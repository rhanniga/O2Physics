...
/// \file candidateSelectorD1ToDstarPi.cxx
/// \brief Selection on D1(2430) -> D*± + π∓ decay candidates
///
/// \author Ryan Hannigan <ryan.hannigan@cern.ch>, UT Austin
// O2
...
// #include "PWGHF/Core/HfMlResponseD1ToDstarPi.h"
...
struct HfCandidateSelectorDstarToD0Pi {
  ...
  Configurable<std::vector<double>> binsPtDstar{"binsPtDstar", std::vector<double>{hf_cuts_d0_to_pi_k::vecBinsPt}, "pT bin limits for Dstar"};
  Configurable<LabeledArray<double>> cutsDstar{"cutsDstar", {hf_cuts_d0_to_pi_k::cuts[0], hf_cuts_d0_to_pi_k::nBinsPt, hf_cuts_d0_to_pi_k::nCutVars, hf_cuts_d0_to_pi_k::labelsPt, hf_cuts_d0_to_pi_k::labelsCutVar}, "Dstar candidate selection per pT bin"};
